package com.example.crudkotlin.network

import com.example.crudkotlin.model.ResultStaff
import com.example.crudkotlin.model.ResultStatus
...
object NetworkConfig {
    ...
    fun getRetrofit(): Retrofit {
        return Retrofit.Builder()
            .baseUrl("http://192.168.18.8/server_udacoding/index.php/ServerApi/")
